...
<head><LINK REL="SHORTCUT ICON" href="images/favicon.ico">
	...
	var fn=document.forms["editform"]["firstname"].value;
	if (fn==null || fn=="")
		{
	...
	var dob1 = document.forms["editform"]["dob"].value;
	if (dob1==null || dob1=="" || !filter.test(em))
		{
	...
	var ety = document.forms["editform"]["Etype"].value;
	if (ety==null || ety=="")
		{
