...
<%
	...
	If (rstContent.EOF <> true) Then ' no recs	
		...
		If (IsNull(rstContent("email"))) Then
			...
			'Response.Redirect("adminchangepassword.asp")
...
<div class="art-nav-outer">
	<ul class="art-hmenu">
			...
			<li>
				<a href="./adminsupport.asp" class="active"><span class="l"></span><span class="r"></span><span class="t">Support</span></a>
			</li>			
		</ul>
</div>
</div>
...
<div class="art-post-inner art-article">
        ...
        <div class="art-footer-text">
			<p><a href="./logout.asp">Logout</a> | <a href="./adminsupport.asp">Support</a></p><p>(C) Super Brilliant Jason. All Rights Reserved.</p>
        </div>
        <div class="cleared"></div>
        </div>
        </div>
