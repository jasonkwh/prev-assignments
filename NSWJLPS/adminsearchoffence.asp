...
<head><LINK REL="SHORTCUT ICON" href="images/favicon.ico">
    ...
    <title>Manage Offence Type</title>
	...
	xmlhttp.open("GET","admingetoffence.asp?o="+offence ,true);
	xmlhttp.send();
	}
	...
	function editOffence(offid)
	{
		setCookie("admineditoffence",offid)
		window.location = "admineditoffence.asp"
	}
...
<div class="art-post-inner art-article">
								...
								<div class="row">
								<span class="label">Name of Type:</span><span class="formw"><input type="text" name="offencename" id="offencename" autocomplete="off" onkeyup="showHint()"/></span>
								</div>
        ...
        <div class="art-footer-text">
			<p><a href="./logout.asp">Logout</a> | <a href="./courtchangepassword.asp">Change Password</a> | <a href="./adminsupport.asp">Support</a></p><p>(C) Super Brilliant Jason. All Rights Reserved.</p>
        </div>
        <div class="cleared"></div>
        </div>
        </div>
