...
<%
	...
	sql="UPDATE offencetype SET "
	sql=sql & "fineamount=" & Request.Form("fineamount") & ","
	sql=sql & "offenceaction=" & Request.Form("offenceaction") & ","
	sql=sql & "offenceStatus=" & Request.Form("Status")
	sql=sql & " WHERE offencename='" & Request.Cookies("admineditoffence") & "'"
...
<head><LINK REL="SHORTCUT ICON" href="images/favicon.ico">
    ...
    <title>Edit Offence Type Confirmation</title>
...
<div class="art-post-inner art-article">
								...
								Offence Type Information Was Updated
                                </h2>
								<div class="cleared"></div>
