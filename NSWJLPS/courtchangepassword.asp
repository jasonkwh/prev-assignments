...
<div class="art-post-inner art-article">
                ...
                <div class="cleared"></div>
								...
								<FORM NAME="changePassword" METHOD=POST ACTION="courtchangepasswordconfirm.asp" onsubmit="return validateForm()">								
                ...
                Change Security Question
                                ...
                                <div class="art-postcontent">
								<br>
								<FORM NAME="changeSecurity" METHOD=POST ACTION="courtchangesecconfirm.asp">
								<div class="row">
