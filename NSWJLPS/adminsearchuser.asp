...
<head><LINK REL="SHORTCUT ICON" href="images/favicon.ico">
	...
	xmlhttp.open("GET","admingetemployee.asp?f="+first+"&l="+last+"&eid="+employeeid ,true);
	xmlhttp.send();
	}
	...
	{
		setCookie("adminedituser",userid)
		window.location = "adminedituser.asp"
	}
...
<div class="art-post-inner art-article">
								...
								<div class="row">
								<span class="label">Employee ID:</span><span class="formw"><input type="text" name="employeeid" id="employeeid" autocomplete="off" onkeyup="showHint()"/></span>
								</div>
